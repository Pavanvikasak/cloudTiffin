...
import 'package:cloud_tiffin/model/CategoryModel.dart';
...
class CategoryController extends GetxController{
  ...
  void getData()async{
    ...
    try{
      print("hey 4");
      final getDataList=await CategoryService.getData(); //Get all blog post list details from the blog post service page
      print("helo yd");
      print(getDataList);
